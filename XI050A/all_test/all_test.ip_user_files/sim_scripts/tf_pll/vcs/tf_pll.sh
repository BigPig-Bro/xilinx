...
#                script (type 'tf_pll.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.tf_pll xil_defaultlib.glbl -o tf_pll_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./tf_pll_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key tf_pll_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc tf_pll_simv.daidir vcs_lib c.obj)
