...
#                script (type 'write_fifo.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/FPGA_work/FPGA_Boards_Git/Xilinx/XI050CD/dual_ov5640_sdram_hdmi/sdram_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
