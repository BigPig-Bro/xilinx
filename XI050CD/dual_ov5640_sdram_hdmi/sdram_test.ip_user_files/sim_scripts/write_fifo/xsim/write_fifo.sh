...
#
# Script generated by Vivado on Sun Feb 22 16:59:58 +0800 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : write_fifo.sh
...
#
# Usage        : write_fifo.sh
#                write_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                write_fifo.sh [-reset_run]
#                write_fifo.sh [-reset_log]
#                write_fifo.sh [-help]
#
...
export RDI_DATADIR="D:/Xilinx20242/Vivado/2024.2/data"
...
# script info
echo -e "write_fifo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./write_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot write_fifo xil_defaultlib.write_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim write_fifo -key {Behavioral:sim_1:Functional:write_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilinx20242/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb write_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./write_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: write_fifo.sh [-help]\n\
Usage: write_fifo.sh [-step]\n\
Usage: write_fifo.sh [-lib_map_path]\n\
Usage: write_fifo.sh [-reset_run]\n\
Usage: write_fifo.sh [-reset_log]\n\
Usage: write_fifo.sh [-keep_index]\n\
Usage: write_fifo.sh [-noclean_files]\n\n\
