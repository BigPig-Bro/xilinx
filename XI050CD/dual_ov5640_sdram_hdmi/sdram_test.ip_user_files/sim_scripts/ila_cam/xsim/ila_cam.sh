...
#
# Script generated by Vivado on Sun Feb 15 12:13:10 +0800 2026
...
#
# Usage        : ila_cam.sh
#                ila_cam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_cam.sh [-reset_run]
#                ila_cam.sh [-reset_log]
#                ila_cam.sh [-help]
#
...
# script info
echo -e "ila_cam.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_cam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_cam xil_defaultlib.ila_cam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_cam -key {Behavioral:sim_1:Functional:ila_cam} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_cam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_cam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_cam.sh [-help]\n\
Usage: ila_cam.sh [-step]\n\
Usage: ila_cam.sh [-lib_map_path]\n\
Usage: ila_cam.sh [-reset_run]\n\
Usage: ila_cam.sh [-reset_log]\n\
Usage: ila_cam.sh [-keep_index]\n\
Usage: ila_cam.sh [-noclean_files]\n\n\
