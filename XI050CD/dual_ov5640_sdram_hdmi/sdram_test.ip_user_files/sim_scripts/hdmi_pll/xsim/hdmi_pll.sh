...
#
# Script generated by Vivado on Fri Feb 13 00:13:09 +0800 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : hdmi_pll.sh
...
#
# Usage        : hdmi_pll.sh
#                hdmi_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                hdmi_pll.sh [-reset_run]
#                hdmi_pll.sh [-reset_log]
#                hdmi_pll.sh [-help]
#
...
# script info
echo -e "hdmi_pll.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./hdmi_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot hdmi_pll xil_defaultlib.hdmi_pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim hdmi_pll -key {Behavioral:sim_1:Functional:hdmi_pll} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb hdmi_pll.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./hdmi_pll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: hdmi_pll.sh [-help]\n\
Usage: hdmi_pll.sh [-step]\n\
Usage: hdmi_pll.sh [-lib_map_path]\n\
Usage: hdmi_pll.sh [-reset_run]\n\
Usage: hdmi_pll.sh [-reset_log]\n\
Usage: hdmi_pll.sh [-keep_index]\n\
Usage: hdmi_pll.sh [-noclean_files]\n\n\
