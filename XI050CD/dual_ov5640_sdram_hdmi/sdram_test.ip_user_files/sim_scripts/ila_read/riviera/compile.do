...
vlog -work xpm  -incr "+incdir+../../../../sdram_test.gen/sources_1/ip/ila_read/hdl/verilog" -l xpm -l xil_defaultlib \
...
vlog -work xil_defaultlib  -incr -v2k5 "+incdir+../../../../sdram_test.gen/sources_1/ip/ila_read/hdl/verilog" -l xpm -l xil_defaultlib \
