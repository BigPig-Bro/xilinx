...
#
# Script generated by Vivado on Sun Feb 15 01:07:44 +0800 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : ila_sdram.sh
...
#
# Usage        : ila_sdram.sh
#                ila_sdram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_sdram.sh [-reset_run]
#                ila_sdram.sh [-reset_log]
#                ila_sdram.sh [-help]
#
...
# script info
echo -e "ila_sdram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_sdram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ila_sdram xil_defaultlib.ila_sdram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ila_sdram -key {Behavioral:sim_1:Functional:ila_sdram} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ila_sdram.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ila_sdram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ila_sdram.sh [-help]\n\
Usage: ila_sdram.sh [-step]\n\
Usage: ila_sdram.sh [-lib_map_path]\n\
Usage: ila_sdram.sh [-reset_run]\n\
Usage: ila_sdram.sh [-reset_log]\n\
Usage: ila_sdram.sh [-keep_index]\n\
Usage: ila_sdram.sh [-noclean_files]\n\n\
