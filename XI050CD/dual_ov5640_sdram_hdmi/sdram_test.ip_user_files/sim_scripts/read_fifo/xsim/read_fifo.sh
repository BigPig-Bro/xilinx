...
#
# Script generated by Vivado on Sun Feb 22 16:44:21 +0800 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : read_fifo.sh
...
#
# Usage        : read_fifo.sh
#                read_fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                read_fifo.sh [-reset_run]
#                read_fifo.sh [-reset_log]
#                read_fifo.sh [-help]
#
...
# script info
echo -e "read_fifo.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./read_fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_11 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot read_fifo xil_defaultlib.read_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim read_fifo -key {Behavioral:sim_1:Functional:read_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb read_fifo.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./read_fifo.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: read_fifo.sh [-help]\n\
Usage: read_fifo.sh [-step]\n\
Usage: read_fifo.sh [-lib_map_path]\n\
Usage: read_fifo.sh [-reset_run]\n\
Usage: read_fifo.sh [-reset_log]\n\
Usage: read_fifo.sh [-keep_index]\n\
Usage: read_fifo.sh [-noclean_files]\n\n\
