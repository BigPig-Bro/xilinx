...
module lut_ov5640_rgb565_640_480_60(
...
begin
	case(lut_index)			  
	    ...
	    10'd223: lut_data <= {8'h78 , 24'h380802};// DVPHO           //640
	    10'd224: lut_data <= {8'h78 , 24'h380980};// DVPHO
		...
		// 10'd255: lut_data <= {8'h78 , 16'h503D,1'd1,3'd0,2'b00,2'd0}; //测试模式([7]-1:En 0:Dis, [3:2]color bar 00:8 Color bar, 01:vertical 1, 10:horizontal , 11:vertical 2),
