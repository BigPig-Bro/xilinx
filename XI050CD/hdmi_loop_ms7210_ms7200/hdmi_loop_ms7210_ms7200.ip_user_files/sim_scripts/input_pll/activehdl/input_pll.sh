...
#                script (type 'input_pll.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/FPGA_work/FPGA_Boards_Git/Xilinx/XI050CD/hdmi_loop_ms7210_ms7200/hdmi_loop_ms7210_ms7200.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
