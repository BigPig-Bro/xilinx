...
#
# Script generated by Vivado on Fri Jun 06 00:51:55 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : input_pll.sh
...
#
# Usage        : input_pll.sh
#                input_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                input_pll.sh [-reset_run]
#                input_pll.sh [-reset_log]
#                input_pll.sh [-help]
#
...
# script info
echo -e "input_pll.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./input_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot input_pll xil_defaultlib.input_pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim input_pll -key {Behavioral:sim_1:Functional:input_pll} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb input_pll.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./input_pll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: input_pll.sh [-help]\n\
Usage: input_pll.sh [-step]\n\
Usage: input_pll.sh [-lib_map_path]\n\
Usage: input_pll.sh [-reset_run]\n\
Usage: input_pll.sh [-reset_log]\n\
Usage: input_pll.sh [-keep_index]\n\
Usage: input_pll.sh [-noclean_files]\n\n\
