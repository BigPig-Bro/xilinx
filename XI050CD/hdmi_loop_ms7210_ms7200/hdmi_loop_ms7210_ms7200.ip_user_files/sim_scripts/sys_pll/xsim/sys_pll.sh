...
#
# Script generated by Vivado on Sat May 24 01:58:11 +0800 2025
...
#
# Usage        : sys_pll.sh
#                sys_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sys_pll.sh [-reset_run]
#                sys_pll.sh [-reset_log]
#                sys_pll.sh [-help]
#
...
# script info
echo -e "sys_pll.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sys_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot sys_pll xil_defaultlib.sys_pll xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb sys_pll.wdb xsim.dir libdpi.so)
...
Usage: sys_pll.sh [-step]\n\
Usage: sys_pll.sh [-lib_map_path]\n\
Usage: sys_pll.sh [-reset_run]\n\
Usage: sys_pll.sh [-reset_log]\n\
Usage: sys_pll.sh [-keep_index]\n\
