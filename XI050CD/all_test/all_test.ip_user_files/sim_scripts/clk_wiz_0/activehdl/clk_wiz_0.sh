...
#
# Script generated by Vivado on Tue Mar 18 21:44:28 +0800 2025
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/FPGA_work/FPGA_Boards_Git/Xilinx/XI050AB/all_test/all_test.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
