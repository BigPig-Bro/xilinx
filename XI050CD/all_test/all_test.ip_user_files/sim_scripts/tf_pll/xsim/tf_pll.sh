...
#
# Script generated by Vivado on Wed Oct 30 00:00:27 +0800 2024
...
#
# Usage        : tf_pll.sh
#                tf_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tf_pll.sh [-reset_run]
#                tf_pll.sh [-reset_log]
#                tf_pll.sh [-help]
#
...
# script info
echo -e "tf_pll.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tf_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 16  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tf_pll xil_defaultlib.tf_pll xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tf_pll -key {Behavioral:sim_1:Functional:tf_pll} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilinx20241/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tf_pll.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tf_pll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tf_pll.sh [-help]\n\
Usage: tf_pll.sh [-step]\n\
Usage: tf_pll.sh [-lib_map_path]\n\
Usage: tf_pll.sh [-reset_run]\n\
Usage: tf_pll.sh [-reset_log]\n\
Usage: tf_pll.sh [-keep_index]\n\
Usage: tf_pll.sh [-noclean_files]\n\n\
